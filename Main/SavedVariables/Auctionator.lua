...
AUCTIONATOR_CONFIG = {
	...
	["selling_reselect_item_2"] = {
		...
		["sortKey"] = "4392_Advanced Target Dummy_0_true",
	},
	["historical_prices"] = {
	},
	["columns_cancelling"] = {
...
AUCTIONATOR_RECENT_SEARCHES = {
	"\"Runic Mana Potion\"", -- [1]
	"\"Runic Mana Injector\"", -- [2]
	"\"Overcharged Capacitor\"", -- [3]
	"\"Frostweave Cloth\"", -- [4]
	"\"Crystallized Air\"", -- [5]
	"\"Eternal Belt Buckle\"", -- [6]
	"\"Sapphire Spellthread\"", -- [7]
	"\"Insightful Earthsiege Diamond\"", -- [8]
	"\"King's Amber\"", -- [9]
	"\"Brilliant King's Amber\"", -- [10]
	"wise", -- [11]
	"holy ligh", -- [12]
	"beacon of", -- [13]
	"seal of wi", -- [14]
