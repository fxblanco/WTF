...
AUCTIONATOR_RECENT_SEARCHES = {
	...
	"\"Cobalt Bar\"", -- [2]
	"\"Handful of Cobalt Bolts\"", -- [3]
	"\"Volatile Blasting Trigger\"", -- [4]
	"\"Frostweave Cloth\"", -- [5]
	"\"Overcharged Capacitor\"", -- [6]
	"\"Fläschchen des Frostwyrms\"", -- [7]
	"\"Trank der wilden Magie\"", -- [8]
	"Fischm", -- [9]
	"Fischmal", -- [10]
	"\"Runenschriftrolle der Seelenstärke\"", -- [11]
	"Inschriftenkunde: Runenschriftrolle der Seelenstärke", -- [12]
	"Seelen", -- [13]
	"\"Globalthermische Pioniersprengladung\"", -- [14]
	"\"Geschwindigkeitstrank\"", -- [15]
	"Pikantes D", -- [16]
	"Deviats", -- [17]
	"Frostwy", -- [18]
	"\"Äonenschatten\"", -- [19]
	"\"Froststoff\"", -- [20]
	"\"Verschleierter Ametrin\"", -- [21]
	"\"Chaotischer Polarlichtdiamant\"", -- [22]
	"äonenleb", -- [23]
	"äonenfeuer", -- [24]
	"Trank der Wilden magie", -- [25]
	"Geschwindigkeitst", -- [26]
	"\"Gewürzte Mammutleckereien\"", -- [27]
	"Gürtelsch", -- [28]
	"\"Sirenenträne\"", -- [29]
	"\"Tollkühner Monarchentopas\"", -- [30]
}
