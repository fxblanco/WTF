...
AUCTIONATOR_RECENT_SEARCHES = {
	"Fischm", -- [1]
	"Fischmal", -- [2]
	"\"Runenschriftrolle der Seelenstärke\"", -- [3]
	"Inschriftenkunde: Runenschriftrolle der Seelenstärke", -- [4]
	"Seelen", -- [5]
	"\"Globalthermische Pioniersprengladung\"", -- [6]
	"\"Trank der wilden Magie\"", -- [7]
	"\"Geschwindigkeitstrank\"", -- [8]
	"Pikantes D", -- [9]
	"Deviats", -- [10]
	"Frostwy", -- [11]
	"\"Äonenschatten\"", -- [12]
	"\"Froststoff\"", -- [13]
	"\"Verschleierter Ametrin\"", -- [14]
	"\"Chaotischer Polarlichtdiamant\"", -- [15]
	"äonenleb", -- [16]
	"äonenfeuer", -- [17]
	"Trank der Wilden magie", -- [18]
	"Geschwindigkeitst", -- [19]
	"\"Gewürzte Mammutleckereien\"", -- [20]
	"Gürtelsch", -- [21]
	"\"Sirenenträne\"", -- [22]
	"\"Tollkühner Monarchentopas\"", -- [23]
	"Mondgesp", -- [24]
	"\"Sonnenglimmertuch\"", -- [25]
	"\"Runenbeschriebener Scharlachrubin\"", -- [26]
	"\"Kristallisierte Luft\"", -- [27]
	"\"Saronitbarren\"", -- [28]
	"\"Geläuterter Zwielichtopal\"", -- [29]
	"runenbeschriebener s", -- [30]
}
