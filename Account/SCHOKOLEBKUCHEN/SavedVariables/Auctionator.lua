...
AUCTIONATOR_RECENT_SEARCHES = {
	...
	"\"Äonenschatten\"", -- [4]
	"\"Froststoff\"", -- [5]
	"\"Verschleierter Ametrin\"", -- [6]
	"\"Chaotischer Polarlichtdiamant\"", -- [7]
	"äonenleb", -- [8]
	"äonenfeuer", -- [9]
	"Trank der Wilden magie", -- [10]
	"Geschwindigkeitst", -- [11]
	"\"Trank der wilden Magie\"", -- [12]
	"\"Gewürzte Mammutleckereien\"", -- [13]
	"\"Geschwindigkeitstrank\"", -- [14]
	"Gürtelsch", -- [15]
	"\"Sirenenträne\"", -- [16]
	"\"Tollkühner Monarchentopas\"", -- [17]
	"Mondgesp", -- [18]
	"\"Sonnenglimmertuch\"", -- [19]
	"\"Runenbeschriebener Scharlachrubin\"", -- [20]
	"\"Kristallisierte Luft\"", -- [21]
	"\"Saronitbarren\"", -- [22]
	"\"Geläuterter Zwielichtopal\"", -- [23]
	"runenbeschriebener s", -- [24]
	"\"Mondgespinst\"", -- [25]
	"\"Äonenfeuer\"", -- [26]
	"\"Äonenleben\"", -- [27]
	"Schleierst", -- [28]
