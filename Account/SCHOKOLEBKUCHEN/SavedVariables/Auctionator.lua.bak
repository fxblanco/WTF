...
AUCTIONATOR_RECENT_SEARCHES = {
	"äonenleb", -- [1]
	"äonenfeuer", -- [2]
	"Trank der Wilden magie", -- [3]
	"Geschwindigkeitst", -- [4]
	"\"Trank der wilden Magie\"", -- [5]
	"\"Gewürzte Mammutleckereien\"", -- [6]
	"\"Geschwindigkeitstrank\"", -- [7]
	"Gürtelsch", -- [8]
	"\"Sirenenträne\"", -- [9]
	"\"Tollkühner Monarchentopas\"", -- [10]
	"Mondgesp", -- [11]
	"\"Sonnenglimmertuch\"", -- [12]
	"\"Runenbeschriebener Scharlachrubin\"", -- [13]
	"\"Äonenschatten\"", -- [14]
	"\"Kristallisierte Luft\"", -- [15]
	"\"Saronitbarren\"", -- [16]
	"\"Geläuterter Zwielichtopal\"", -- [17]
	"\"Chaotischer Polarlichtdiamant\"", -- [18]
	"runenbeschriebener s", -- [19]
	"\"Mondgespinst\"", -- [20]
	"\"Äonenfeuer\"", -- [21]
	"\"Äonenleben\"", -- [22]
	"Schleierst", -- [23]
