...
AUCTIONATOR_RECENT_SEARCHES = {
	"\"Klobiger Kardinalsrubin\"", -- [1]
	"\"Stattlicher Schreckensstein\"", -- [2]
	"\"Klares Auge von Zul\"", -- [3]
	"Rolle der waffenverzauberung - B", -- [4]
	"Rolle der waffenverzauberung - ", -- [5]
	"Rolle der waffe", -- [6]
	"Rolle der w", -- [7]
	"Verzauberung", -- [8]
	"Waffen Ver", -- [9]
	"Waffenverzauberung: Ber", -- [10]
	"Berserker", -- [11]
	"\"Titanbeschlag\"", -- [12]
	"Göttliche bitte", -- [13]
