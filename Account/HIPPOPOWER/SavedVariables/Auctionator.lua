...
AUCTIONATOR_RECENT_SEARCHES = {
	...
	"Gediegener für", -- [4]
	"Gedigener f", -- [5]
	"\"Frostbalgbeinrüstung\"", -- [6]
	"schreckensstein", -- [7]
	"Auge von ZUl", -- [8]
	"\"Kristallisierte Luft\"", -- [9]
	"\"Saronitbarren\"", -- [10]
	"\"Robustes Auge von Zul\"", -- [11]
	"\"Spiegelnder Königsbernstein\"", -- [12]
	"\"Unerbittlicher Erdringdiamant\"", -- [13]
	"drachena", -- [14]
	"kardinalsru", -- [15]
	"Präziser k", -- [16]
	"\"Eisbannbrustschutz\"", -- [17]
	"\"Große Planaressenz\"", -- [18]
	"\"Ametrin\"", -- [19]
	"\"Runenbeschriebene Kugel\"", -- [20]
	"\"Traumsplitter\"", -- [21]
	"schreckenssetin", -- [22]
	"Ametrin", -- [23]
	...
	"widerstand", -- [29]
	"\"Geläuterter Schreckensstein\"", -- [30]
}
