...
AUCTIONATOR_RECENT_SEARCHES = {
	"\"Kobaltbarren\"", -- [1]
	"\"Überladener Kondensator\"", -- [2]
	"\"Jormungarschuppe\"", -- [3]
	"\"Froststoff\"", -- [4]
	"\"Kristallisierte Erde\"", -- [5]
	"\"Arktischer Pelz\"", -- [6]
	"\"Boreanisches Leder\"", -- [7]
	"\"Gefrorene Kugel\"", -- [8]
	"\"Eisige Drachenschuppe\"", -- [9]
	"\"Nerubisches Chitin\"", -- [10]
	"\"Frostbalgbeinrüstung\"", -- [11]
	"\"Eisschuppenbeinrüstung\"", -- [12]
	"\"Kristallisiertes Wasser\"", -- [13]
	"\"Schweres boreanisches Leder\"", -- [14]
	"äonenwas", -- [15]
	"äonensc", -- [16]
	"äonnsc", -- [17]
	"Teufelsbalg", -- [18]
	"Schweres Knotenhautl", -- [19]
	"Knotenhautleder", -- [20]
	"Knotenhautlederfetzen", -- [21]
	"\"Unverwüstliches Leder\"", -- [22]
	"Schildkrötenschuppe", -- [23]
	"Geschmeidiger schwerer Balg", -- [24]
	"Eiserne Gürtelschnalle", -- [25]
