...
AUCTIONATOR_RECENT_SEARCHES = {
	...
	"cardinal", -- [2]
	"\"Dreadstone\"", -- [3]
	"\"Chaotic Skyflare Diamond\"", -- [4]
	"dreadst", -- [5]
	"\"Purified Dreadstone\"", -- [6]
	"\"Verschleierter Ametrin\"", -- [7]
	"\"Ametrin\"", -- [8]
	"Ametrin", -- [9]
	"kardinalsru", -- [10]
	"\"Schreckensstein\"", -- [11]
	"\"Geläuterter Schreckensstein\"", -- [12]
	"königsbern", -- [13]
	"könogsbernds", -- [14]
	...
	"\"Saronitbarren\"", -- [19]
	"\"Robustes Auge von Zul\"", -- [20]
	"\"Spiegelnder Königsbernstein\"", -- [21]
	"\"Unerbittlicher Erdringdiamant\"", -- [22]
	"drachena", -- [23]
	"Präziser k", -- [24]
	"\"Eisbannbrustschutz\"", -- [25]
	"\"Große Planaressenz\"", -- [26]
	"\"Runenbeschriebene Kugel\"", -- [27]
	"\"Traumsplitter\"", -- [28]
	"schreckenssetin", -- [29]
