...
AUCTIONATOR_RECENT_SEARCHES = {
	"\"Unerbittlicher Erdringdiamant\"", -- [1]
	"erdringd", -- [2]
	"schwarztuchr", -- [3]
	"mantel des r", -- [4]
	"erwachte h", -- [5]
	...
	"windreißerg", -- [8]
	"Ymirj", -- [9]
	"Robe des heilers y", -- [10]
	"reinhornsch", -- [11]
	"Bindungen der Tie", -- [12]
	"Frostwy", -- [13]
	"Runenbeschriebener Kardinalsr", -- [14]
	"unbest", -- [15]
	"gürtelsch", -- [16]
	"\"Unbeständiger Schreckensstein\"", -- [17]
	"\"Gravierter Ametrin\"", -- [18]
	"Ametrin", -- [19]
	"schleiers", -- [20]
	"drachenauge", -- [21]
	"Kardinalsr", -- [22]
	"Dunkelmond", -- [23]
	"\"Titanstahlzerstörer\"", -- [24]
	"\"Titanband des Einschlags\"", -- [25]
	"\"Gesichtsmaske des Ausweiders\"", -- [26]
	"\"Umhang der blutigen Wasser\"", -- [27]
	"\"Trollweberschiftung\"", -- [28]
	"\"Schweres boreanisches Leder\"", -- [29]
	"\"Gefrorene Kugel\"", -- [30]
}
