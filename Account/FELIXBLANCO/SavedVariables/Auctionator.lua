...
AUCTIONATOR_RECENT_SEARCHES = {
	"\"Frostbalgbeinrüstung\"", -- [1]
	"schreckensstein", -- [2]
	"Auge von ZUl", -- [3]
	"\"Kristallisierte Luft\"", -- [4]
	"\"Saronitbarren\"", -- [5]
	"\"Robustes Auge von Zul\"", -- [6]
	"\"Spiegelnder Königsbernstein\"", -- [7]
	"\"Unerbittlicher Erdringdiamant\"", -- [8]
	"drachena", -- [9]
	"kardinalsru", -- [10]
	"Präziser k", -- [11]
	"\"Eisbannbrustschutz\"", -- [12]
	"\"Große Planaressenz\"", -- [13]
	"\"Ametrin\"", -- [14]
	"\"Runenbeschriebene Kugel\"", -- [15]
	"\"Traumsplitter\"", -- [16]
	"schreckenssetin", -- [17]
	"Ametrin", -- [18]
	"\"Glänzender Zauberfaden\"", -- [19]
	"Geringes Fläschchen des Widerstands", -- [20]
	"fläschen des widerstands", -- [21]
	"geringen widerstands", -- [22]
	"geringen widerstand", -- [23]
	"widerstand", -- [24]
	"\"Geläuterter Schreckensstein\"", -- [25]
	"mächtiger Am", -- [26]
	"tödlicher amet", -- [27]
	"\"Knochenband des Herolds\"", -- [28]
	"\"Kobaltbarren\"", -- [29]
