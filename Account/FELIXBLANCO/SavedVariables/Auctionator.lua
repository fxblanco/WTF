...
AUCTIONATOR_RECENT_SEARCHES = {
	...
	"kardinalsru", -- [4]
	"\"Schreckensstein\"", -- [5]
	"\"Geläuterter Schreckensstein\"", -- [6]
	"königsbern", -- [7]
	"könogsbernds", -- [8]
	"\"Frostbalgbeinrüstung\"", -- [9]
	"schreckensstein", -- [10]
	"Auge von ZUl", -- [11]
	"\"Kristallisierte Luft\"", -- [12]
	"\"Saronitbarren\"", -- [13]
	"\"Robustes Auge von Zul\"", -- [14]
	"\"Spiegelnder Königsbernstein\"", -- [15]
	"\"Unerbittlicher Erdringdiamant\"", -- [16]
	"drachena", -- [17]
	"Präziser k", -- [18]
	"\"Eisbannbrustschutz\"", -- [19]
	"\"Große Planaressenz\"", -- [20]
	"\"Runenbeschriebene Kugel\"", -- [21]
	"\"Traumsplitter\"", -- [22]
	"schreckenssetin", -- [23]
	"\"Glänzender Zauberfaden\"", -- [24]
	"Geringes Fläschchen des Widerstands", -- [25]
	"fläschen des widerstands", -- [26]
	"geringen widerstands", -- [27]
	"geringen widerstand", -- [28]
	"widerstand", -- [29]
	"mächtiger Am", -- [30]
}
