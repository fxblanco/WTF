...
AUCTIONATOR_RECENT_SEARCHES = {
	...
	"fläschen des widerstands", -- [2]
	"geringen widerstands", -- [3]
	"geringen widerstand", -- [4]
	"widerstand", -- [5]
	"\"Geläuterter Schreckensstein\"", -- [6]
	"mächtiger Am", -- [7]
	"tödlicher amet", -- [8]
	"Auge von ZUl", -- [9]
	"\"Knochenband des Herolds\"", -- [10]
	"\"Kobaltbarren\"", -- [11]
	"siegel des lichts", -- [12]
	"schreckensstein", -- [13]
	"Bombensch", -- [14]
	"\"Titanring der Frostwache\"", -- [15]
	"Blutsaug", -- [16]
	"Frostw", -- [17]
	"Ametrin", -- [18]
	"\"Goldklee\"", -- [19]
	...
	"\"Alptraumträne\"", -- [21]
	"\"Reiner Ametrin\"", -- [22]
	"\"Unerbittlicher Erdringdiamant\"", -- [23]
	"titanbe", -- [24]
	"\"Tiefenkristall\"", -- [25]
	"\"Traumsplitter\"", -- [26]
	"\"Schleierstaub\"", -- [27]
	"\"Große kosmische Essenz\"", -- [28]
	"\"Unberechenbarer Sprengauslöser\"", -- [29]
	"runenbeschriebener k", -- [30]
}
