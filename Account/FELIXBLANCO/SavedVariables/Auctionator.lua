...
AUCTIONATOR_RECENT_SEARCHES = {
	...
	"Froststoff", -- [7]
	"\"Überladener Kondensator\"", -- [8]
	"\"Unerbittlicher Erdringdiamant\"", -- [9]
	"\"Strenger Erdringdiamant\"", -- [10]
	"\"Ametrin\"", -- [11]
	"Wachpostenumhang", -- [12]
	"Klinge von Schattenf", -- [13]
	"Klinge von Shadowfang", -- [14]
	"Assassinenklinge", -- [15]
	"ewige g", -- [16]
	"\"Spiegelnder Königsbernstein\"", -- [17]
	"\"Glänzender Königsbernstein\"", -- [18]
	"\"Massiver Königsbernstein\"", -- [19]
	"\"Tollkühner Ametrin\"", -- [20]
	"\"Gediegener Fürstenzirkon\"", -- [21]
	"\"Fürstenzirkon\"", -- [22]
	"\"Königsbernstein\"", -- [23]
	"\"Klobiger Kardinalsrubin\"", -- [24]
	"\"Titanerz\"", -- [25]
	"titanstahl", -- [26]
	"titanstalerz", -- [27]
	"titanstahlerz", -- [28]
