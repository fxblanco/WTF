...
AUCTIONATOR_RECENT_SEARCHES = {
	...
	"\"Ametrin\"", -- [6]
	"Ametrin", -- [7]
	"\"Glänzender Zauberfaden\"", -- [8]
	"Geringes Fläschchen des Widerstands", -- [9]
	"fläschen des widerstands", -- [10]
	"geringen widerstands", -- [11]
	"geringen widerstand", -- [12]
	"widerstand", -- [13]
	"\"Geläuterter Schreckensstein\"", -- [14]
	"mächtiger Am", -- [15]
	"tödlicher amet", -- [16]
	"Auge von ZUl", -- [17]
	"\"Knochenband des Herolds\"", -- [18]
	"\"Kobaltbarren\"", -- [19]
	"siegel des lichts", -- [20]
	"Bombensch", -- [21]
	"\"Titanring der Frostwache\"", -- [22]
	"Blutsaug", -- [23]
	"Frostw", -- [24]
	"\"Goldklee\"", -- [25]
	"\"Spiegelnder Königsbernstein\"", -- [26]
	"\"Alptraumträne\"", -- [27]
	"\"Reiner Ametrin\"", -- [28]
	"\"Unerbittlicher Erdringdiamant\"", -- [29]
	"titanbe", -- [30]
}
