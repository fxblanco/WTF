...
AUCTIONATOR_RECENT_SEARCHES = {
	"\"Große Planaressenz\"", -- [1]
	"\"Ametrin\"", -- [2]
	"schreckensstein", -- [3]
	"\"Runenbeschriebene Kugel\"", -- [4]
	"\"Traumsplitter\"", -- [5]
	"kardinalsru", -- [6]
	"schreckenssetin", -- [7]
	"Ametrin", -- [8]
	"\"Glänzender Zauberfaden\"", -- [9]
	"Geringes Fläschchen des Widerstands", -- [10]
	"fläschen des widerstands", -- [11]
	"geringen widerstands", -- [12]
	"geringen widerstand", -- [13]
	"widerstand", -- [14]
	"\"Geläuterter Schreckensstein\"", -- [15]
	"mächtiger Am", -- [16]
	"tödlicher amet", -- [17]
	"Auge von ZUl", -- [18]
	"\"Knochenband des Herolds\"", -- [19]
	"\"Kobaltbarren\"", -- [20]
	"siegel des lichts", -- [21]
	"Bombensch", -- [22]
	"\"Titanring der Frostwache\"", -- [23]
	"Blutsaug", -- [24]
	"Frostw", -- [25]
	"\"Goldklee\"", -- [26]
	...
	"\"Alptraumträne\"", -- [28]
	"\"Reiner Ametrin\"", -- [29]
	"\"Unerbittlicher Erdringdiamant\"", -- [30]
}
