...
AUCTIONATOR_RECENT_SEARCHES = {
	...
	"schreckensstein", -- [4]
	"schreckensstein ", -- [5]
	"schreckensstein des w", -- [6]
	"\"Äonenfeuer\"", -- [7]
	"\"Schleierstaub\"", -- [8]
	"\"Froststoff\"", -- [9]
	"\"Glänzender Zauberfaden\"", -- [10]
	"\"Ametrin\"", -- [11]
	"Fürstenz", -- [12]
	"\"Kardinalsrubin\"", -- [13]
	"Kardinalsr", -- [14]
	...
	"schreckenss", -- [16]
	"Froststoff", -- [17]
	"\"Überladener Kondensator\"", -- [18]
	"\"Unerbittlicher Erdringdiamant\"", -- [19]
	"\"Strenger Erdringdiamant\"", -- [20]
	"Wachpostenumhang", -- [21]
	"Klinge von Schattenf", -- [22]
	"Klinge von Shadowfang", -- [23]
	"Assassinenklinge", -- [24]
	"ewige g", -- [25]
	"\"Spiegelnder Königsbernstein\"", -- [26]
	"\"Glänzender Königsbernstein\"", -- [27]
	"\"Massiver Königsbernstein\"", -- [28]
	"\"Tollkühner Ametrin\"", -- [29]
	"\"Gediegener Fürstenzirkon\"", -- [30]
}
