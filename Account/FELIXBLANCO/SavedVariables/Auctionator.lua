...
AUCTIONATOR_RECENT_SEARCHES = {
	...
	"\"Traumsplitter\"", -- [11]
	"\"Schleierstaub\"", -- [12]
	"\"Große kosmische Essenz\"", -- [13]
	"\"Unberechenbarer Sprengauslöser\"", -- [14]
	"runenbeschriebener k", -- [15]
	"runenb", -- [16]
	"mächtiger Am", -- [17]
	"\"Geläuterter Schreckensstein\"", -- [18]
	"Kardinalsr", -- [19]
	"\"Geschwindigkeitstrank\"", -- [20]
	"titanring", -- [21]
	"schreckensstein ", -- [22]
	"schreckensstein des w", -- [23]
	"\"Äonenfeuer\"", -- [24]
	"\"Froststoff\"", -- [25]
	"\"Glänzender Zauberfaden\"", -- [26]
	"\"Ametrin\"", -- [27]
	"Fürstenz", -- [28]
	"\"Kardinalsrubin\"", -- [29]
	"krad", -- [30]
