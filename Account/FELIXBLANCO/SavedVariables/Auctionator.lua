...
AUCTIONATOR_RECENT_SEARCHES = {
	...
	"schreckensstein", -- [4]
	"Auge von ZUl", -- [5]
	"\"Kristallisierte Luft\"", -- [6]
	"\"Saronitbarren\"", -- [7]
	"\"Robustes Auge von Zul\"", -- [8]
	"\"Spiegelnder Königsbernstein\"", -- [9]
	"\"Unerbittlicher Erdringdiamant\"", -- [10]
	"drachena", -- [11]
	"kardinalsru", -- [12]
	"Präziser k", -- [13]
	"\"Eisbannbrustschutz\"", -- [14]
	"\"Große Planaressenz\"", -- [15]
	"\"Ametrin\"", -- [16]
	"\"Runenbeschriebene Kugel\"", -- [17]
	"\"Traumsplitter\"", -- [18]
	"schreckenssetin", -- [19]
	"Ametrin", -- [20]
	"\"Glänzender Zauberfaden\"", -- [21]
	"Geringes Fläschchen des Widerstands", -- [22]
	"fläschen des widerstands", -- [23]
	"geringen widerstands", -- [24]
	"geringen widerstand", -- [25]
	"widerstand", -- [26]
	"\"Geläuterter Schreckensstein\"", -- [27]
	"mächtiger Am", -- [28]
	"tödlicher amet", -- [29]
	"\"Knochenband des Herolds\"", -- [30]
}
