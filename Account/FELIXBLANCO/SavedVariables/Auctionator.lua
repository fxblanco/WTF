...
AUCTIONATOR_RECENT_SEARCHES = {
	...
	"\"Ametrin\"", -- [4]
	"Ametrin", -- [5]
	"\"Glänzender Zauberfaden\"", -- [6]
	"Geringes Fläschchen des Widerstands", -- [7]
	"fläschen des widerstands", -- [8]
	"geringen widerstands", -- [9]
	"geringen widerstand", -- [10]
	"widerstand", -- [11]
	"\"Geläuterter Schreckensstein\"", -- [12]
	"mächtiger Am", -- [13]
	"tödlicher amet", -- [14]
	"Auge von ZUl", -- [15]
	"\"Knochenband des Herolds\"", -- [16]
	"\"Kobaltbarren\"", -- [17]
	"siegel des lichts", -- [18]
	"Bombensch", -- [19]
	"\"Titanring der Frostwache\"", -- [20]
	"Blutsaug", -- [21]
	"Frostw", -- [22]
	"\"Goldklee\"", -- [23]
	"\"Spiegelnder Königsbernstein\"", -- [24]
	"\"Alptraumträne\"", -- [25]
	"\"Reiner Ametrin\"", -- [26]
	"\"Unerbittlicher Erdringdiamant\"", -- [27]
	"titanbe", -- [28]
	"\"Tiefenkristall\"", -- [29]
	"\"Traumsplitter\"", -- [30]
}
